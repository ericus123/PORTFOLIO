...
const UpdateForm = ({
  ...
  return (
    ...
    >
      <Form.Row>
        <Form.Group as={Col}>
          <Form.Label className={styles.form_label}>First Name</Form.Label>
          <Form.Control
            type="text"
            placeholder="Ex: JOHN"
            name="first_name"
        ...
        <Form.Group as={Col}>
          <Form.Label className={styles.form_label}>Last Name</Form.Label>
          <Form.Control
            type="text"
            placeholder="Ex: Doe"
            name="last_name"
      ...
      <Form.Row>
        ...
        <Form.Group as={Col}>
          <Form.Label className={styles.form_label}>Occupation</Form.Label>
          <Form.Control
            type="text"
      ...
      <Form.Row>
        <Form.Group as={Col}>
          <Form.Label className={styles.form_label}>Bio</Form.Label>
          <Form.Control
            as="textarea"
            rows={3}
            name="bio"
